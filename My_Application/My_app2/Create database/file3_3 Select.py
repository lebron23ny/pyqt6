...
steel_name = 'С345Б'
thickness = 9
cursor.execute(f'SELECT steel_name, Ryn, Run, Ry, Ru, Rbp_A, Rbp_B FROM Data_Ibeam_material WHERE steel_name = "{steel_name}" AND thickness_min <={thickness} AND thickness_max > {thickness}')
